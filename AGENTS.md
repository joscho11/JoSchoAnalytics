...
- Retracted in-repo HIGH was 129/238 (54.20%). The frozen 2021-2025 benchmark is 302/535 = 56.45% ATS, Wilson 52.90%, above 52.4%: median-triggered tickets graded at the best US Tuesday number. Starting in 2026, the chosen shopped quote drives display, execution and grading. HIGH still qualifies off the Tuesday US median. Do not move qualification onto the shopped quote: shopping only ever moves the line toward the bet, so it loosens the 2.5 cut to about 2.2. Measured 2021-2025, shop-flag/shop-grade is 335/603 = 55.56%, Wilson 0.5221, under 0.524, and the 68 tickets it adds went 33-35 (48.53%). Cut is 2.5. Median on the benchmark tickets was 299/538. Prior cut 3 was 246/442. Never claim CLV.
